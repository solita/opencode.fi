...
(function ($) {
  ...
  $projects.html("<tr><td colspan='4'>Loading content...</td></tr>");
  ...
  $.getJSON("projects.json", function(data) {
      ...
      var content = data.projects.map(function (project) {
          ...
          if (project.code_url.length > 1) {
              codeUrl = "<a href='" + $("<td>").text(project.code_url).html() + "'>See source code &raquo;</a>";
          }

          if (project.service_url.length > 1) {
              serviceUrl = "<a href='" + $("<td>").text(project.service_url).html() + "'>Open the service &raquo;</a>";
          }
